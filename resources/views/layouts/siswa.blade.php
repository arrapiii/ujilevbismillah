...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" {{ Request::is('profilsiswa*') ? ' active' : '' }} href="/profilsiswa">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" {{ Request::is('jadwal*') ? ' active' : '' }}href="/jadwal">
