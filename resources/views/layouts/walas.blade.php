...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"{{ Request::is('profilwalas*') ? ' active' : '' }} href="/profilwalas">
          <i class="bi bi-grid"></i>
          <span>Profile Walas</span>
        </a>
      </li><!-- End Dashboard Nav -->

      <li class="nav-item">
        <a class="nav-link collapsed" {{ Request::is('jadwalkonseling*') ? ' active' : '' }}href="/jadwalkonseling">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" {{ Request::is('hasilkonseling*') ? ' active' : '' }}   href="/hasilkonseling">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed"{{ Request::is('petakerawanan*') ? ' active' : '' }} href="/petakerawanan">
          <i class="bi bi-person-gear"></i>
