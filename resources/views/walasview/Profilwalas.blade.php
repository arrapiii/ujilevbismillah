            ...
            <div class="row" >
              <div class="col-8" >
                <div class="card mb-4" style="height: auto;">
                  ...
                  <div class="card-body mb-4" id="profile-info">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="mb-3">
                            ...
                            <input type="text" name="namagurukelas" class="form-control" id="edit-nama" value="{{ $user->walikelas->namaguru }}">
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="mb-3">
                            <label for="edit-nip" class="form-label">Email</label>
                            <input type="text" name="email" class="form-control" id="edit-email" value="{{ $user->email }}">
                          </div>
                        </div>
                      </div>
                      <div class="row">
              ...
              <div class="col-4" >
                ...
                <div class="profile-picture pt-3 p-5 pr-2 d-block align-items-center text-center" style="margin: 0 auto;  ">
                  <div class="foto-container" style="margin: 0 auto; width: 200px; height: 200px;">
                    <img src="{{ asset('fotoguru/'.$user->walikelas->foto) }}" alt="Foto Pengguna" id="foto">
                  </div>
